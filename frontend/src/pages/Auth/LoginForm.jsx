...
const LoginForm = () => {
            ...
            <div className="svgContainer">
                <div id="login-div">
                    ...
                    >
                        ...
                        {/* ... (The rest of the <g>, <path>, <rect>, etc. goes here) */}
                        <g className="earL">
                            <g
                                className="outerEar"
                                fill="#ddf1fa"
    ...
    c0.5,0,1,0.3,1.2,0.7c0.4,0.7,0.1,1.5-0.6,1.9c-2.6,1.4-5.3,2.2-7.9,2.5C101.7,101,100.5,101,100.2,101z"
                            ...
                            <path
                                ...
                                style={{ display: "none" }}
                                d="M95,104.2c-4.5,0-8.2-3.7-8.2-8.2v-2c0-1.2,1-2.2,2.2-2.2h22c1.2,0,2.2,1,2.2,2.2v2 
    c0,4.5-3.7,8.2-8.2,8.2H95z"
                            />
                            <path
                                className="mouthLargeBG"
                                style={{ display: "none" }}
                                d="M100 110.2c-9 0-16.2-7.3-16.2-16.2 0-2.3 1.9-4.2 4.2-4.2h24c2.3 0 4.2 1.9 4.2 4.2 
    ...
    c0.5,0,1,0.3,1.2,0.7c0.4,0.7,0.1,1.5-0.6,1.9c-2.6,1.4-5.3,2.2-7.9,2.5C101.7,101,100.5,101,100.2,101z"
            ...
            <div className="inputGroup inputGroup1">
                ...
                <input type="email" id="loginEmail" maxLength="254" placeholder="Enter email or username"/>
            </div>
